    ...
    return (
        <main className = "bg-gray-300 min-h-screen p-12">
            <section className = "container mx-auto">
                <h1 className = "text-5xl flex justify-center cursive">MyProjects</h1>
                ...
                <section className = "grid grid-cols-1 gap-8 sm:grid-cols-1 md:grid-cols-2">
                    ...
                    <article className = "transition duration-500 ease-in-out hover:bg-gray-200 transform relative rounded-lg shadow-xl bg-white p-16 hover:-translate-y-1 hover:scale-105">
